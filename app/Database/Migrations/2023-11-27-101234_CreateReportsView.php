...
class CreateReportsView extends Migration
{
    public function up()
    {
        ...
        $this->db->query('
            ...
            select  t3.nm_kec, t4.nm_desa, t1.luas, t1.bulan, t1.minggu, t2.name, t2.type 
            from reports t1
            ...
            where (t1.minggu, t1.bulan, t1.id_desa) in ( select max(minggu) as minggu, bulan, id_desa  from reports group by bulan, id_desa)
        ');
    }
